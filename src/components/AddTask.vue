...
<template>
  <Teleport to="body">
    <div class="fixed bg:#00000099 inset:0 flex flex:col justify-content:center align-items:center">
      <div class="rel">
        ...
        <form @submit.prevent class="p:12 r:8 bg:white flex flex:col gap-y:12">
          ...
          <div class="flex justify-content:end">
            <button class="py:8 px:16 r:4 bg:blue-50 f:white" type="button" @click="handleSubmit">
              {{ $t('add_task.add') }}
            </button>
          </div>
        </form>
